...
function usePaginationItem(props) {
  ...
  const FragmentWrapper = isLink ? "a" : import_react2.Fragment;
...
var PaginationItem = (0, import_system2.forwardRef)((props, ref) => {
  const { Component, FragmentWrapper, fragmentWrapperProps, children, getItemProps } = usePaginationItem({ ...props, ref });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { ...getItemProps(), children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FragmentWrapper, { ...fragmentWrapperProps, children }) });
});
