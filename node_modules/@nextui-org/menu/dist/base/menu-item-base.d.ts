...
type MenuItemBaseProps<T extends object = {}> = Props<T> & Omit<MenuItemVariantProps, "hasDescriptionTextChild" | "hasTitleTextChild"> & AriaMenuItemProps & FocusableProps & PressEvents;
